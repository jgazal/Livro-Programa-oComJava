...
class GenericMethodDemo {
    ...
    static <T, V extends T> boolean arraysEqual(T[] x, V[] y) { //um método genérico
// Se os tamanhos dos arrays forem diferentes, os arrays também serão.
    ...
    public static void main(String[] args) {
        ...
        if(arraysEqual(nums, nums))                 //Os argumentos de tipo de T e V são determinados
            System.out.println("nums equals nums"); //implicitamente quando o método é chamado
